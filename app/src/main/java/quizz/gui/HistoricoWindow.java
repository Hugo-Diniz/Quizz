...
public class HistoricoWindow extends javax.swing.JFrame {
    ...
    private void initTable() {
        ...
        List<Integer> historico = service.getHistorico();
        
        for (int i = 0; historico.size() > i; i++) {
            modelo.addRow(new String[] {String.valueOf(historico.get(i))});
        }
        
        historicoTable.setModel(modelo);
        historicoTable.setDefaultEditor(Object.class, null);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HistoricoWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HistoricoWindow().setVisible(true);
            }
        });
    }
