...
public class RemoverPerguntaWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Remover Pergunta");
        ...
        jScrollPane1.setViewportView(perguntaTable);
        if (perguntaTable.getColumnModel().getColumnCount() > 0) {
            perguntaTable.getColumnModel().getColumn(0).setResizable(false);
            perguntaTable.getColumnModel().getColumn(1).setResizable(false);
            perguntaTable.getColumnModel().getColumn(2).setResizable(false);
            perguntaTable.getColumnModel().getColumn(3).setResizable(false);
        }
    ...
    private void removerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removerButtonActionPerformed
        executor.executeCommand(new RemoverPerguntaCommandGUI(perguntaTable, this));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoverPerguntaWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new RemoverPerguntaWindow().setVisible(true);
//            }
//        });
    }
